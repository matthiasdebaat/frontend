...
export class CloudBackupPref extends LitElement {
        ...
        <div class="content">
          ${this._backupConfig
            ...
            : html`<ha-card outlined
                ><div class="spinner"><ha-spinner></ha-spinner></div
              ></ha-card>`}
  ...
  private _renderStatusCard() {
    const cloudBackup = this._getLastCloudBackup();
    ...
    return html`
      ...
      >
        ...
        <div class="card-actions">
          <ha-button appearance="filled" href="/config/backup">
            ${this.hass.localize(
  ...
  private _getLastCloudBackup(): BackupContent | undefined {
    if (!this._backupInfo?.backups) {
      return undefined;
    }
    return this._backupInfo.backups
